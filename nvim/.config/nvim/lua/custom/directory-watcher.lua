-- Directory watcher using libuv fs_event API
-- Source: https://github.com/richardgill/nix/blob/bdd30a0/modules/home-manager/dot-files/nvim/lua/custom/directory-watcher.lua
local M = {}
...
M.setup = function(opts)
	...
	-- recursive = true to watch all subdirectories
