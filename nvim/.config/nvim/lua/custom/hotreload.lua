-- Hot-reload buffers when external tools modify files
-- Source: https://github.com/richardgill/nix/blob/bdd30a0/modules/home-manager/dot-files/nvim/lua/custom/hotreload.lua
